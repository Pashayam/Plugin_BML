...
public class BmlAttributeValueManipulator extends AbstractElementManipulator<XmlAttributeValue> {
    private static final Logger LOG = Logger.getInstance(BmlAttributeValueManipulator.class);
    ...
    public XmlAttributeValue handleContentChange(@NotNull XmlAttributeValue element, @NotNull TextRange range, String newContent) throws IncorrectOperationException {
        ...
        final XmlTag tag = XmlElementFactory.getInstance(project).createTagFromText(text);
