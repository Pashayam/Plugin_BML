...
public class BmlFileHighlighter extends SyntaxHighlighterBase {
    ...
    public BmlFileHighlighter() {
        this(false);
    }

    public BmlFileHighlighter(boolean dtd) {
        myIsDtd = dtd;
    }

    public BmlFileHighlighter(boolean dtd, boolean xhtml) {
        myIsDtd = dtd;
        myIsXHtml = xhtml;
    }
